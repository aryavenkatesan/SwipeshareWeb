                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-white/80">
                                <li className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-violet-300 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <span>hello@swipeshare.app</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-violet-300 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                    <span>+1 (248) 720-9839</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-violet-300 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span>875 MLK Dr.<br />Chapel Hill, NC 27514</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 mb-6">
                                {/* Facebook */}
                                <a href="#" className="w-10 h-10 bg-gray-800 rounded-lg items-center justify-center hover:bg-purple-600 transition-colors hidden lg:flex">
                                ...
                                {/* Instagram */}
                                <a href="https://www.instagram.com/swipeshare.app/" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-purple-600 transition-colors">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="border-t border-gray-800 py-6 sm:pt-2">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="text-sm text-gray-400">
                            © {currentYear} Swipeshare. All rights reserved.
                        </div>
